...
def sample_bbox(seed, stdev, count, canvas_shape):
...
def sample_bbox_from_motion_model(seed, motion, stdev, count, canvas_shape):
    """
    TODO: Denenmedi
    :param seed:
    :param motion:
    ...
    return sample_bbox([x_new, y_new, w_new, h_new],stdev,count,canvas_shape)
    # return bboxes
