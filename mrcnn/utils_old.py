...
def sample_bbox(seed, stdev, count):
    ...
    for i in range(count):
        bboxes[0, i, 0] = random.gauss(x, stdev)
        bboxes[0, i, 1] = random.gauss(y, stdev)
        bboxes[0, i, 2] = random.gauss(w, stdev)
        bboxes[0, i, 3] = random.gauss(h, stdev)
...
def sample_bbox_from_motion_model(seed, motion, stdev, count):
    # sample format = [x_part, y_part, w_part, h_part]
    x, y, w, h = seed
    ...
    for i in range(count):
        bboxes[0, i, 0] = random.gauss(x_new, stdev)
        bboxes[0, i, 1] = random.gauss(y_new, stdev)
        bboxes[0, i, 2] = random.gauss(w_new, stdev)
        bboxes[0, i, 3] = random.gauss(h_new, stdev)
